...
.PHONY: audit build clean coverage-check docs-audit fmt fmt-check help lint modernize-check race test test-integration test-integration-cover test-integration-live test-integration-smoke test/cover tidy vuln
