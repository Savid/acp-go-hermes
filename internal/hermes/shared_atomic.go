...
//
//nolint:govet // Narrow setup scope keeps the directory error adjacent to its operation; every caller confines path beneath an already-validated adapter-owned root.
