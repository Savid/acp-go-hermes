...
// A successfully delivered marker consumes the candidate sequence like any
// other delivery. It then proves the final marker envelope also fits; the
// route nonce bound ensures route metadata alone cannot make the marker exceed
// the cap.
