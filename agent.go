...
// session-establishing method as hermes_invalid_options.
...
// internalClassNativeStart is the hermes_internal_failure class of a native
// hermes process that could not be started or configured for a session.
